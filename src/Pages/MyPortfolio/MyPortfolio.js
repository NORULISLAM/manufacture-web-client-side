    ...
    return (
        <div className="card lg:card-side bg-base-100 shadow-xl m-16">
            ...
            <div className="card-body m-10">
                ...
                - <a className="link link-secondary" href="https://inventroy-management.web.app/">Inventory Management system</a>

                - <a className="link link-secondary" href="https://stately-axolotl-fb7c01.netlify.app/">Review site</a>
                - <a className="link link-secondary" href=" https://regal-yeot-e26758.netlify.app/login">Jewel academey</a>
            </div>
        </div>
    );
};
